...
function loadMetabase(options, arch, sdks, settings, callback, generate) {
	...
	var otherFrameworks = options.imports != undefined ? path.resolve(process.cwd(), options.imports) : null;

	xcode.frameworksFromDir(otherFrameworks, function(err, thirdPartyFrameworks) {
		opts.thirdPartyFrameworks = options.thirdPartyFrameworks = thirdPartyFrameworks;
		xcode.systemFrameworks(function(err,frameworks) {
			frameworks = frameworks.concat(thirdPartyFrameworks);
